...
def correct_sheets_data():
    """Правильное исправление структуры данных из Google Sheets"""
    
    print("🔧 Правильное исправление структуры данных из Google Sheets...")
    ...
    for sheet_product in sheets_data:
        ...
        print(f"✅ Исправлен товар: {item['title']} - {item['price']}")
    ...
    try:
        with open('corrected_sheets_data.json', 'w', encoding='utf-8') as f:
            json.dump(corrected_items, f, ensure_ascii=False, indent=2)
        print(f"✅ Исправленные данные сохранены в corrected_sheets_data.json")
    except Exception as e:
    ...
    print(f"📊 Статистика:")
    print(f"   - Товаров исправлено: {len(corrected_items)}")
